...
public class DownloaderTaskFragment extends Fragment {
	...
	public static ArrayList<Integer> sRawTextFeedIds;
	@SuppressWarnings("unused")
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sRawTextFeedIds = args.getIntegerArrayList(TAG_FRIEND_RES_IDS);
		Integer[] temp = new Integer[sRawTextFeedIds.size()];
		for(int i=0;i<sRawTextFeedIds.size();i++)
			temp[i] = sRawTextFeedIds.get(i);

		// TODO: Start the DownloaderTask
		new DownloaderTask().execute(temp);
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (mainActivityDead) {
                                ...
                                PendingIntent pi = PendingIntent.getActivity(mContext,0,restartMainActivityIntent,PendingIntent.FLAG_UPDATE_CURRENT);//restartMainActivityIntent
                                ...
                                // successfully
                                mContentView.setTextViewText(R.id.text,"Download Completed successfully! WHAAAT !?!");
                                ...
                                Notification.Builder notificationBuilder = new Notification.Builder(mContext)
                                        .setTicker("TwitterApp Download Complete")
                                        .setAutoCancel(true)
